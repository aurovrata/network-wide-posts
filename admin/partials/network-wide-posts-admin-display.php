...
<form id="form_result" method="post">
    ...
    <?php
      ...
      ?>
        <li id="post-<?php echo $post->net_wide_id;?>" class="<?php echo $alternate?>">
          <span class="title nwp-column"><?php echo $post->post_title;?></span><span class="blog-id nwp-column"><?php echo $post->blog_id;?></span><span class="slug nwp-column"><?php echo $post->post_name;?></span>
        </li>
    <?php
